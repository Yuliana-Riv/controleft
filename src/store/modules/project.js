...
export default {
    ...
    actions:{
        setAddedPrj({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionPrj({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },

        async getAllInfoPrj({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
        ...
        async getInfoByIdPrj({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async searchPrj({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
        ...
        async deleteItemPrj({ commit }, payload) { 
        ...
        async editItemPrj({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
        ...
        async addItemPrj({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
