        ...
        <ul>
          ...
          <li
            ...
            @click="
              activeMenu(0),
                setOption('Project'),
                setHistoryOptionPrj('Default')
            "
          >
            <div class="text-menu"><span>PROYECTOS</span></div>
            <div v-if="navOption == 'Project'" class="icon-active">
              <div class="ico"></div>
            </div>
          </li>
          ...
          <li
            ...
            @click="
              activeMenu(0),
                setOption('Blog'),
                setHistoryOptionBlo('Default')
            "
          >
            <div class="text-menu"><span>BLOG</span></div>
            <div v-if="navOption == 'Blog'" class="icon-active">
              <div class="ico"></div>
            </div>
          </li>
          ...
          <li
            ...
            "
          >
            <div class="text-menu"><span>CATEGORIA</span></div>
            <div v-if="navOption == 'Category'" class="icon-active">
              <div class="ico"></div>
            </div>
          </li>
  ...
  methods: {
   ...
   ...mapActions('logo', ['getAllInfoLgo']),
    ...
    setOption: function (option) {
      if (option == "MenuP" || option == "MenuC" || option == "MenuCo") {
